// IzaacWeb V4 - Bot Terminal RPG Module
...
function chooseClass(input) {
    ...
    clearText();
    typeText(`Your adventure begins in a world where both wonder and chaos coexist.\n\nYou are the only one who can survive and experience all of this.\n\nYou have chosen the ${type} class. Your HP is ${hp} and your DMG is ${attack}.\n\nAs you explore the forest, you keep hearing noises around you.\n\nPrepared for any threat, you see your first enemy approaching.\n\nA wild wolf charges at you. Prepare to battle. Pick a number between 0-1`);
...
function battleBoss(input) {
    ...
    if (input === '/nuke' || move == input) {
        ...
        typeText(`Uncertain of what could happen next, you became scared of the dark abomination that was right in front of you, and then it suddenly grabbed you and everything turned dark, including your shiny ${weapon}.\n\nYou died.`);
        showTryAgainButton();
    }
    currentRPGState = '';
}
